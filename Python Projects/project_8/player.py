...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        # first, we want to check if the previous mive is a winner
        # this is our base case
        if state.current_winner == other_player:
            # we should return position AND score because we need to keep track of the score for minmax to work
        ...
        for possible_move in state.available_moves():
            ...
            # step 2: recursive using minimax to simulate a game after making that move
